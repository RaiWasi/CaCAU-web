...
@JsonPropertyOrder({ "Arguments", "Command", "Data", "DataCount", "DateTime", "Message", "Source", "Status",
		"YPDataServiceVersion", "YPDatabaseVersion" })
public class APIYellowPageAircraftsResponse {
	...
	@JsonProperty("Data")
	private List<Aircraft> data = null;
